...
class InsightsScreen extends StatelessWidget {
            ...
            child:
              ...
              AppCard(
                  child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                    const Text('Best Performing Habits',
                        style: TextStyle(
                            fontWeight: FontWeight.w800,
                            fontSize: 18,
  ...
  String _coach(HabitProvider hp) {
    if (hp.habits.isEmpty) {
      return 'Start with 3 habits: one health, one learning, and one personal goal.';
    }
    if (hp.progress == 1) {
      return 'Perfect day. Keep the streak alive tomorrow.';
    }
    if (hp.progress >= .5) {
      return "Good pace. Finish one more habit to strengthen today's momentum.";
    }
  ...
  String _recommend(HabitProvider hp) {
    ...
    if (hp.bestStreak < 3) {
      return 'Use reminders and choose easier goals until you reach your first 3-day streak.';
    }
